...
public class CheckQuestionsAnswersTest extends BasePage {

    private final String questionNumber;
    private final String answerNumber;
    private final String expected;

    public CheckQuestionsAnswersTest(String questionNumber, String answerNumber, String expected) {
        super(driver);
    ...
    @Test
    public void checkQuestionButtonTextMatch() {
        BasePage basePage = new BasePage(driver)
                .openUrl()
                .scrollToQuestion()
                .clickQuestionButton(questionNumber);
        BasePage.getQuestionText(answerNumber);
        String actual = BasePage.getQuestionText(answerNumber);
